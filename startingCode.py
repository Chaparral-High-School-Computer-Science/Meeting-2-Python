...
# Create 2 variables num1 and num2, asking for user input. Then create the variable result, which adds num1 & num2. Print result 
...
lastTwo = studentID         # How can we get the last two digits?  
